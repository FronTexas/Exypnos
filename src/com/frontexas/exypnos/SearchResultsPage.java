...
//						doctor.getSpeciality(), doctor.getAppointmentDate(),
...
//			Doctor d = new Doctor(names[i], type[i], dates[i], address[i]);
//			doctorsList.add(d);
//		}
//	}
//
...
//		Doctor d = div.getDoctor();
//		i.putExtra("name", d.getName());
//		i.putExtra("type", d.getSpeciality());
//		i.putExtra("address", d.getHospitalName());
//		startActivity(i);
//
//	}
//}
